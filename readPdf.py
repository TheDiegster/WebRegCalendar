...
lecture.begin = dt(2024, 1, 3, int(startHour), startMinFirst, startMinSecond, tzinfo=pytz.timezone("America/Los_Angeles"))
# we need to find a way to do repeat until!
lecture.end = dt(2024, 1, 3, int(endHour), endMinFirst, endMinSecond, tzinfo=pytz.timezone("America/Los_Angeles"))
